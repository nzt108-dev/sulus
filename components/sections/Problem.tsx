...
const problems: ProblemItem[] = [
  {
    Icon: UserIcon,
    text: "Customers often do not know who is actually moving the vehicle.",
  },
  {
    Icon: DollarIcon,
    text: "Brokers increase cost and create communication gaps between customers and drivers.",
  },
  {
    Icon: LinkIcon,
    text: "Drivers need direct access to customers — not another middleman.",
  },
  {
    Icon: ClockIcon,
    text: "Small dealers and car flippers need faster repeat transport options.",
  },
  {
    Icon: MapPinIcon,
    text: "Pickup owners have earning potential but no simple place to find local opportunities.",
  },
];
